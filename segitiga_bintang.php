...
/**nilai tinggi segitiga */
	...
	for($b=10; $b>$a; $b--)
    {
        /**Perulangan dalam dengan variabel counter $b. nilai b=10, akan dilakukan perulangan sebanyak b>a dan setiap kali perulangan nilainya akan berkurang satu  */
		echo "*";
	}
    /** jika berhasil akan dilanjutkan dengan mencetak bintang*/
	echo "<br>";
	...
	/** 2. setelah perulangan luar berhasil, lanjut ke perulangan dalam. yaitu  b=10, nilai b > a (berhasil) ini merupakan perulangan ke 10, lalu akan dilanjutkan ke pencetakan bintang  */
